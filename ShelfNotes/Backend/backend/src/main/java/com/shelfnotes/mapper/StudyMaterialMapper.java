...
public class StudyMaterialMapper {
    ...
    /**
     * Converts StudyMaterialRequestDTO to StudyMaterial Entity
     */
    public static StudyMaterial toEntity(StudyMaterialRequestDTO dto) {
    ...
    /**
     * Converts StudyMaterial Entity to StudyMaterialResponseDTO
     */
    public static StudyMaterialResponseDTO toResponse(StudyMaterial material) {
        ...
        return StudyMaterialResponseDTO.builder()
                ...
                .category(CategoryMapper.toResponse(material.getCategory()))
